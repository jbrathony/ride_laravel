				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						@if(LOGIN_USER_TYPE != 'company')
							...
							@if($result->driver->company->id == 1 && $result->driver->bank_detail == '')
							<div class="form-group">
								<label class="col-sm-3 control-label">
								</label>
								<div class="col-sm-6 col-sm-offset-1 form-control-static">
						...
						@if($result->driver->company_id == 1 && $result->driver->bank_detail != '')
						<div class="form-group">
							<label class="col-sm-3 control-label">
						...
						<div class="form-group">
							...
							<div class="col-sm-6 col-sm-offset-1 form-control-static">
								{{ $result->driver->bank_detail->holder_name }}
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">
							...
							<div class="col-sm-6 col-sm-offset-1 form-control-static">
								{{ $result->driver->bank_detail->bank_name }}
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">
							...
							<div class="col-sm-6 col-sm-offset-1 form-control-static">
								{{ $result->driver->bank_detail->bank_location }}
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">
							...
							<div class="col-sm-6 col-sm-offset-1 form-control-static">
								{{ $result->driver->bank_detail->code }}
							</div>
						</div>
						@endif
						...
						@if($result->driver->company_id != 1)
							...
							@if($result->driver->company->default_payout_credentials != '')
								...
								<div class="form-group">
									...
									<div class="col-sm-6 col-sm-offset-1 form-control-static">
										{{ $result->driver->company->default_payout_credentials->code }}
									</div>
								</div>
							@endif
						@endif
