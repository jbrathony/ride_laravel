  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        @if(@$user->can('email_settings') || @$user->can('send_email'))
        ...
        <!-- @if($company_user || @$user->can('manage_driver_payments') || @$user->can('manage_company_payments'))
          <li class="{{ (Route::current()->uri() == 'admin/payout/overall') ? 'active' : ''  }}"><a href="{{ url('admin/payout/overall') }}"><i class="fa fa-dollar"></i><span> Manage Driver Payouts</span></a></li>
        @endif -->
            ...
            @if($company_user || @$user->can('manage_wallet'))
              <li class="treeview {{ (@$navigation == 'manage_wallet') ? 'active' : ''  }}">
                <a href="#"><i class="fa fa-dollar"></i>
                  <span> Manage Wallet Amount </span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                   <li class="treeview {{ (@$user_type == 'Driver') ? 'active' : ''  }}">
                    <a href="{{ route('wallet',['user_type' => 'Driver']) }}"><i class="fa fa-circle-o"></i>
                      <span> Driver </span>
                    </a>
                  </li>
                  <li class="{{ (@$user_type == 'Rider') ? 'active' : ''  }}">
        ...
        @if($company_user || @$user->can('manage_owe_amount'))
          <li class="{{ (Route::current()->uri() == $first_segment.'/owe') ? 'active' : ''  }}"><a href="{{ url($first_segment.'/owe') }}"><i class="fa fa-money"></i><span>Manage Owe Amount</span></a>
          </li>
        @endif
