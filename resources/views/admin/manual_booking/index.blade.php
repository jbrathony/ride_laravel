	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-3" ng-init="country_code={{(@$schedule_ride->users->country_code==null)?$country_code_option[0]->phone_code:@$schedule_ride->users->country_code}}">
				<select class ='form-control selectpicker' id = 'input_country_code' name='country_code' ng-model="country_code">
			...
			<div class="col-md-8 map-wrap">
				<div class="map-route-option">
					...
					<div class="fare-btn clearfix">
						<button class="btn btn-primary submit_button change_field" disabled ng-disabled="myForm.$invalid && page_loading==0" ng-click="submitForm();">
