        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                {!! Form::select('payment_currency', $currency, site_settings('payment_currency'), ['class' => 'form-control', 'id' => 'input_payment_currency','disabled' => 'disabled']) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                {!! Form::select('heat_map',['On'=>'On','Off'=>'Off'], old('heat_map',$result[11]->value), ['class' => 'form-control', 'id' => 'input_heat_map']) !!}
