    ...
    <div class="col-lg-12 col-md-12 col-sm-11 col-xs-12 dash-panel">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 headlog">
            ...
            <a href="#" data-slide-menu="#slide-menu" data-slide-menu-content="#slide-menu-content" class="text--uppercase menu-a">
                <span class="icon icon_settings-alt push-half--right color--neutral micro">
                </span>{{trans('messages.header.menu')}}</a>
                </button>
                <div class="nav-div" style="padding:0px !important;">
                    ...
                    <div class="flexbox__item flexbox__item--expand">
                        <ul class="site-nav site-nav--flush site-nav--dark block-list push-half--bottom">
                            ...
                            <li>
                                <a href="{{ url('driver_payment') }}">{{trans('messages.header.payment')}}</a>
                            </li>
                            <li>
                                <a href="{{ url('driver_invoice') }}" class="free-rides-button">{{trans('messages.header.invoice')}}</a>
                            </li>
                            <li>
                                <a href="{{ url('driver_trip') }}">{{trans('messages.header.mytrips')}}</a>
                            </li>
                            <li>
                                <a href="{{ url('sign_out')}}" class="free-rides-button hide-md-760">{{trans('messages.header.logout')}}</a>
                            </li>
                        </ul>
                    ...
                    <li class="user-flyout flyout flyout--right">
                        ...
                        <div class="flyout__content" style="margin:-4px 0px 0px 0px !important;padding:0px;">
                            <ul class="site-nav site-nav--flush">
                                ...
                                <li>
                                    <a href="{{ url('driver_profile') }}" >{{trans('messages.header.profil')}}</a>
                                </li>
                                <li>
                                    <a href="{{ url('driver_payment') }}">{{trans('messages.header.payment')}}</a>
                                </li>
