...
<div class=" text-center signupdrive" ng-controller="facebook_account_kit">
  ...
  <div class="join-page" >
    <div class="layout layout--join_company layout--hero" >
      ...
      <div class="layout__item layout--join__hero-item soft-gutter z-30" style="padding-top:0 !important;" >
        <div class="layout" style=" margin-left: -40px;"
          ...
          {{ Form::open(array('url' => 'company_register','class' => 'layout layout--flush driver-signup-form-join-legacy','id'=>'form')) }} 
          {{csrf_field()}}
          ...
          <input type="hidden" name="user_type" value="Company">
              ...
              <div class="layout__item one-whole createacc" >
                <a class="btn btn--primary btn--full" href="{{ url('signin_company')}}" style="background-color:#09091a !important;border:none;padding:12px;" >
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 push-tiny--bottom--legacy pull-left" id="pad-sm-right" style="padding:0px;" >
                <div class="_style_3EKecM" >                  
                  {!! Form::text('name', '', ['class' => '_style_3vhmZK','placeholder' => trans('messages.profile.name'),'id' => 'fname' ]) !!}
                </div>
           ...
           <input type="hidden" name="country_code" value="{{ old('country_code',(isset($country_code) ? $country_code : '')) }}">
            <div class="select select--xl" ng-init="old_country_code={{old('country_code')!=null? old('country_code') : '1'}}">
                ...
                <!-- <select name="country_code" style="display:none" tabindex="-1" id="mobile_country" class="square borderless--right"> -->
    ...
    <form action="{{url('/company_register')}}" method="post" id="form">
