...
class PermissionsTableSeeder extends Seeder
{
	...
	public function run()
    {
		...
		DB::table('permissions')->insert([
	        ...
	        ['name' => 'manage_vehicle_type',     'display_name' => 'Manage Vehicle Type',            'description' => 'Manage Vehicle Type'],
	        ...
	        ['name' => 'manage_driver_payments',        'display_name' => 'Manage Driver Payments',       	'description' => 'Manage Driver Payments'],              
	        ...
	        ['name' => 'manage_referral_settings',     	'display_name' => 'Manage Referral Settings',     	'description' => 'Manage Referral Settings'],
	        ['name' => 'manage_rider_referrals',       	'display_name' => 'Manage Rider Referral',        	'description' => 'Manage Rider Referral'],
	        ['name' => 'manage_driver_referrals',      	'display_name' => 'Manage Driver Referral',       	'description' => 'Manage Driver Referral'],
	        ['name' => 'view_manage_reason',            'display_name' => 'View Manage Reason',              'description' => 'View Manage Reason'],     
	        ['name' => 'add_manage_reason',             'display_name' => 'Add Manage Reason',               'description' => 'Add Manage Reason'],
	        ['name' => 'edit_manage_reason',            'display_name' => 'Edit Manage Reason',              'description' => 'Edit Manage Reason'],
	        ['name' => 'delete_manage_reason',          'display_name' => 'Delete Manage Reason',            'description' => 'Delete Manage Reason'],
	        ['name' => 'view_additional_reason',       	'display_name' => 'View Additional Reason',          'description' => 'View Additional Reason'],     
	        ['name' => 'add_additional_reason',        	'display_name' => 'Add Additional Reason',           'description' => 'Add Additional Reason'],
	        ['name' => 'edit_additional_reason',       	'display_name' => 'Edit Additional Reason',          'description' => 'Edit Additional Reason'],
	        ['name' => 'delete_additional_reason',     	'display_name' => 'Delete Additional Reason',        'description' => 'Delete Additional Reason'],
	    ]);
	}
}