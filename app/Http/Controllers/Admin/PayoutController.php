	...
	*/
    public function payout_to_driver(Request $request)
    {
    	...
    	if($type == 'driver_trip') {
	        ...
	        $payout_details     = $trip_details->driver->bank_detail;
	        ...
	        $payout_details     = $trip_details[0]->driver->bank_detail;
        ...
        if($payout_details == null) {
            $this->helper->flash_message('danger', 'Yet, driver doesn\'t enter his Payout details. Cannot Make Payout.');
	...
	/**
    * Make Payout to the driver
    *
    * @param String $payout_type   Type
    * @param Collection $payout_details instance of Driver Payout
    * @param String $trip_currency  Currency Code
    * @param Float $amount  Amount
    * @param Array $trip_ids  Payout Trip Id's
    */
    public function make_driver_payout($payout_type, $payout_details, $trip_currency, $amount,$trip_ids = '')
    {
