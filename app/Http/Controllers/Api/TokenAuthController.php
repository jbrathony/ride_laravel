...
class TokenAuthController extends Controller
{
    ...
    public function common_data(Request $request)
    {
        ...
        $data = compact('heat_map','sinch_key','sinch_secret_key','apply_trip_extra_fee','admin_contact','status','braintree_env','braintree_public_key','google_map_key','fb_id');

        return response()->json(array_merge($return_data,$data));
    }
}