...
class RequestHelper
{
	...
	{
		$drop_geocode = file_get_contents_curl('https://maps.googleapis.com/maps/api/geocode/json?latlng=' . $lat1 . ',' . $lat2 . '&key=' . MAP_KEY);
     ...
     * 
     * @return Object Status and Intent id
     */
    public function getStripeTransactionId($payment_intent_id)
    {
        ...
        return arrayToObject(['status' => false,'status_message' => __('messages.api.payment_not_completed')]);
    }
    ...
    public function getTimeZone($lat1, $lat2)
    {
        ...
        $geo_timezone = file_get_contents_curl('https://maps.googleapis.com/maps/api/timezone/json?location=' . @$lat1 . ',' . @$lat2 . '&timestamp=' . $timestamp . '&key=' . MAP_KEY);
