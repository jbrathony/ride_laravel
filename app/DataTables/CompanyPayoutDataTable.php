    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($trips) {
                $bank_details = $trips->driver->company->default_payout_credentials;
                $bank_data = array();
                if($bank_details != '') {
                ...
                $company_payout = count($bank_data) > 0 ? '<a data-href="#" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#payout-details" data-payout_details=\''.json_encode($bank_data).'\'><i class="glyphicon glyphicon-list-alt"></i></a>&nbsp;' : '';
