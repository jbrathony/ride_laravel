...
class DriverPaymentDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            ['data' => 'cash_trip_amount', 'name' => 'cash_trip_amount', 'title' => 'Amount To Company'],
            ['data' => 'paid_amount', 'name' => 'paid_amount', 'title' => 'Amount Paid'],
            ['data' => 'currency_code', 'name' => 'trips.currency_code', 'title' => 'Currency Code','orderable' => false],
