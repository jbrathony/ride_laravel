...
Route::group(['prefix' => (LOGIN_USER_TYPE=='company')?'company':'admin', 'middleware' =>'admin_guest'], function () {
	...
	Route::group(['middleware' => 'admin_can:manage_send_message'], function() {
		Route::match(array('GET', 'POST'), 'send_message', 'SendmessageController@index');
	...
	Route::match(array('GET', 'POST'), 'add_rider', 'RiderController@add')->middleware('admin_can:add_rider');
	Route::match(array('GET', 'POST'), 'edit_rider/{id}', 'RiderController@update')->middleware('admin_can:edit_rider');
	...
	Route::match(array('GET', 'POST'), 'add_driver', 'DriverController@add')->middleware('admin_can:add_driver');
	Route::match(array('GET', 'POST'), 'edit_driver/{id}', 'DriverController@update')->middleware('admin_can:edit_driver');
	...
	Route::match(array('GET', 'POST'), 'add_company', 'CompanyController@add')->middleware('admin_can:add_company');
	Route::match(array('GET', 'POST'), 'edit_company/{id}', 'CompanyController@update')->middleware('admin_can:edit_company');
	...
	Route::group(['middleware' => 'admin_can:manage_locations'], function() {
	    ...
	    Route::match(array('GET', 'POST'),'add_location', 'LocationsController@add');
	    Route::match(array('GET', 'POST'),'edit_location/{id}', 'LocationsController@update');
	...
	Route::group(['middleware' => 'admin_can:manage_peak_based_fare'], function() {
	    ...
	    Route::match(array('GET', 'POST'),'add_manage_fare', 'ManageFareController@add');
	    Route::match(array('GET', 'POST'),'edit_manage_fare/{id}', 'ManageFareController@update');
    ...
    Route::match(array('GET', 'POST'),'add-additional-reason', 'TollReasonController@add')->middleware('admin_can:add_additional_reason');
    Route::match(array('GET', 'POST'),'edit-additional-reason/{id}', 'TollReasonController@update')->middleware('admin_can:edit_additional_reason');
	...
	Route::group(['middleware' =>  'admin_can:manage_vehicle_type'], function() {
		...
		Route::match(array('GET', 'POST'), 'add_car_type', 'VehicleTypeController@add');
		Route::match(array('GET', 'POST'), 'edit_car_type/{id}', 'VehicleTypeController@update');
		Route::match(array('GET', 'POST'), 'delete_car_type/{id}', 'VehicleTypeController@delete');
	});
	...
	Route::match(array('GET', 'POST'), 'add-cancel-reason', 'CancelReasonController@add')->middleware('admin_can:add_manage_reason');
	Route::match(array('GET', 'POST'), 'edit-cancel-reason/{id}', 'CancelReasonController@update')->where('id', '[0-9]+')->middleware('admin_can:edit_manage_reason');
	...
	Route::match(array('GET', 'POST'), 'email_settings', 'EmailController@index')->middleware(['admin_can:email_settings']);
    Route::match(array('GET', 'POST'), 'send_email', 'EmailController@send_email')->middleware(['admin_can:send_email']);
});